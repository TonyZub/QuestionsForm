...
function SetInnerPageElements(pageElements, message){
  ...
  GetElementById(PAGE_DIV_ID).innerHTML = pageElements.page
  GetElementById(STYLE_NODE_ID).innerHTML = pageElements.style
  GetElementById(CODE_NODE_ID).innerHTML = pageElements.code
